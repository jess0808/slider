...
var quizQuestions = [];
quizQuestions[0] = new QuizItem("What is the most important ingredient in making ice cream?", 
						["Eggs",
						 "Sugar",
						 "Milk",
						 "Flavoring"], 
...
quizQuestions[1] = new QuizItem("Which of the following was the first widely available ice cream flavor?", 
						["Cookies and Cream",
...
quizQuestions[2] = new QuizItem("How many times is ice cream frozen in the production process?",
						["1",
						 "2",
						 "3",
						 "4"],
...
quizQuestions[3] = new QuizItem("How tall was the world's tallest ice cream cone?",
						["2 meters", "9 feet", "1 yard", "5 feet"],
						1,
						false,
						false,
						undefined);

quizQuestions[4] = new QuizItem("What is the world's favorite ice cream topping?",
						["Sprinkles",
						"Chocolate Chips",
						"Fruit",
						"Chocolate Syrup"],
...
function showCurrentQuestion() {
	...
	var pTag = document.getElementsByTagName('h6')[0];
	// console.log(liTags);
	var ulTag = document.getElementsByTagName('ul')[1];
	var liTags = ulTag.getElementsByTagName('li');
